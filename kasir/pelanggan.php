                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" type="button" class="" href="logout.php">
                                Logout
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Jumblah Pelanggan: <?=$h2;?></div>
                                </div>
                            </div>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editpelanggan"  data-bs-dismiss="modal">Submit</button>
                                    ...
                                    <div class="modal fade" id="delete<?=$idpl;?>">
                                        <div class="modal-dialog">
                                            ...
                                            <!-- Modal footer -->
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapuspelanggan"  data-bs-dismiss="modal">Submit</button>
                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                            </div>
                                            </form>
                                            </div>
...
<!-- The Modal -->
    ...
    <div class="modal-dialog">
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
            <button type="submit" class="btn btn-success" name="tambahpelanggan"  data-bs-dismiss="modal">Submit</button>
            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
        </div>
        </form>
        </div>
