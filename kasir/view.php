                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editdetailpesanan"  data-bs-dismiss="modal">Submit</button>
                                            ...
                                            <div class="modal fade" id="delete<?=$idpr;?>">
                                                <div class="modal-dialog">
                                                    ...
                                                    <!-- Modal Header -->
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Apakah anda yakin ingin mengapus barang ini?</h4>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                    </div>
                                                    ...
                                                    <!-- Modal body -->
                                                    <div class="modal-body">
                                                        Apakah anda yakin ingin mengapus barang ini?
