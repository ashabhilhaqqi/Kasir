                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Jumblah barang: <?=$h2;?></div>
                                </div>
                            </div>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editbarang"  data-bs-dismiss="modal">Submit</button>
                                    ...
                                    <div class="modal fade" id="delete<?=$idproduk;?>">
                                        <div class="modal-dialog">
                                            ...
                                            <!-- Modal footer -->
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusbarang"  data-bs-dismiss="modal">Submit</button>
                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                            </div>
                                            </form>
                                            </div>
...
<!-- The Modal -->
    ...
    <div class="modal-dialog">
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
            <button type="submit" class="btn btn-success" name="tambahbarang"  data-bs-dismiss="modal">Submit</button>
            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
        </div>
        </form>
        </div>
